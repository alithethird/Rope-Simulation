...
namespace OpenGL
{
    public class RopeControl : BaseGLControl
    {
        ...
        public RopeSimulation ropeSimulation2;
        # endregion


        # region Constructor
        public RopeControl(RopeSimulation ropeSimulation, RopeSimulation ropeSimulation2)
        {
            InitializeComponent();
            this.ropeSimulation = ropeSimulation;
            this.ropeSimulation2 = ropeSimulation2;
            ropeSimulation.GetMass(ropeSimulation.numOfMass - 1).vel.z = 10;
            ropeSimulation2.GetMass(ropeSimulation2.numOfMass - 1).vel.z = 10;
        ...
        public RopeControl()
        {
            ...
            InitializeComponent();
            ropeSimulation2 = new RopeSimulation(new Vector3D(-1, -1, -1),   // conection position of Rope
                                                   80,						// 80 Particles (Masses)
                                                   0.15,					// Each Particle Has A Weight Of 50 Grams
                                                   50000.0,				// springConstant In The Rope
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            GL.glVertex3d(-20, ropeSimulation.groundHeight * scale, 20);
            GL.glVertex3d(20, ropeSimulation2.groundHeight * scale, 20);
            GL.glVertex3d(-20, ropeSimulation2.groundHeight * scale, 20);
            ...
            for (int i = 0; i < ropeSimulation.numOfMass - 1; i++)
            {
                ...
                Vector3D pos3 = ropeSimulation2.GetMass(i).pos;
                Vector3D pos4 = ropeSimulation2.GetMass(i + 1).pos;
                ...
                GL.glVertex3d(pos3.x * scale, ropeSimulation2.groundHeight * scale, pos3.z * scale); // Shadoe at GroundHeight
                GL.glVertex3d(pos4.x * scale, ropeSimulation2.groundHeight * scale, pos4.z * scale);
                GL.glEnd();
            ...
            for (int i = 0; i < ropeSimulation.numOfMass - 1; i++)
            {
                ...
                GL.glVertex3d(pos3.x * scale, pos3.y * scale, pos3.z * scale);
                GL.glVertex3d(pos4.x * scale, pos4.y * scale, pos4.z * scale);
                GL.glEnd();
